...
**"Derivative Works"** means any work, whether in Source or Object form, that is based on (or derived from) the Work.
...
## 4. Sovereign Freedoms (Additional Protections)
...
- **Free Speech Safe Harbour**: No idea, proposal, critique, or adversarial testing may be censored or punished under this License solely for its content, provided it does not violate the conditions below.
...
**Donations and Value Exchange**  
Donations to the creators and stewards of works published under this License are encouraged as a voluntary value exchange. See DONATIONS.md for current methods. When you publish your own work under BSOL, you are encouraged to include your own donation information in your project documentation.
...
You are not required to accept this License in order to receive or run a copy of the Work. However, nothing other than this License grants you permission to propagate or modify the Work. These actions infringe copyright if you do not accept this License. Therefore, by modifying or propagating the Work (or any work based on the Work), you indicate your acceptance of this License to do so.

---

## 9. Compatibility

This License is compatible with the Apache License 2.0, MIT License, BSD licenses, and CC0. Works originally licensed under those terms may be combined with works under this License while retaining their original terms where applicable.

---

**End of License**

This License is the canonical text. It may be updated only through the documented governance process of the project. All prior versions remain valid for works that adopted them.